...
# LED Power supply:
ps_voltage = 2.513 # V, for single voltage
#for sweep
ps_vmin = 2.54
ps_vmax = 2.55
ps_vstep = -0.005
...
sm_data, ps_data = cam1sm2ps1(Cam,Sm, Ps, ps_voltage, num_images=num_images, savepath=f"{savepath}", timewait=30)
